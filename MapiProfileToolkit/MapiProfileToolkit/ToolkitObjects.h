...
enum {
	...
	SCENARIO_CLONEPROFILE, // 2
	SCENARIO_ADDSERVICE, // 3
	SCENARIO_ADDMAILBOX, // 4
	SCENARIO_ADDPST, // 5
	SCENARIO_ADDLDAPADDRESSLIST, // 6
	SCENARIO_SETCACHEDMODECONFIGURATION, // 7
	SCENARIO_LISTPROFILECONFIGURATION, // 8
	SCENARIO_LISTPSTS, // 9
	SCENARIO_CONVERTADDITIONALMAILBOXESTOACCOUNTS // 9
};
