...
#define PROFILEMODE_DEFAULT (ULONG)1 
#define PROFILEMODE_ONE (ULONG)2
#define PROFILEMODE_ALL (ULONG)3
...
enum { ACTION_ADD = 1, ACTION_REMOVE, ACTION_EDIT, ACTION_LIST, ACTION_UPDATE, ACTION_PROMOTEDELEGATE, ACTION_ADDDELEGATE, ACTION_CLONE, ACTION_SIMPLECLONE, ACTION_ENABLECACHEDMODE};
